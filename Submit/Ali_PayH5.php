...
$payurl=$siteurl."?price=".$price."&userId=".$userId."&memo=INTL-".rand(10000000,99999999)."&trade_no=".$trade_no;

/* 免签交流群 714841732 */
if (strpos($_SERVER['HTTP_USER_AGENT'], 'Alipay') !== false ) {
  if(empty($_GET['price'])||$_GET['price']==''||empty($_GET['userId'])||$_GET['userId']==''||empty($_GET['memo'])||$_GET['memo']==''){
...
//$payurl=$siteurl."?price=".$price."&userId=".$userId."&memo=Q".rand(10000000,99999999);
