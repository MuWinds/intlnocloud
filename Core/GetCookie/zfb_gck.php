...
function trimall($str){
    ...
    return str_replace($qian, '', $str);   
      ...
      /*
    扫描状态文本 ＝ 网页访问u (“https://securitycore.alipay.com/barcode/barcodeProcessStatus.json?securityId=” ＋ 子文本替换 (qrCodeSecurityId, “|”, “%7C”, , , 真) ＋ “&_callback=light.request._callbacks.callback” ＋ 到文本 (a), 0, , cookies, , “User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 UBrowser/6.2.4094.1 Safari/537.36”, , , , , )
       */
      ...
      if(strstr($txt,"confirmed")){
      	//开始处理
      	/*
      	网页访问u (“https://authgtj.alipay.com/login/index.htm”, 1, “support=000001&needTransfer=&CtrlVersion=1%2C1%2C0%2C1&loginScene=index&redirectType=&personalLoginError=&goto=https%3A%2F%2Fconsumeprod.alipay.com%2Frecord%2Fstandard.htm&errorVM=&sso_hid=&site=&errorGoto=&rds_form_token=” ＋ rds_form_token ＋ “&json_tk=&method=qrCodeLogin&logonId=&superSwitch=true&noActiveX=false&passwordSecurityId=” ＋ 子文本替换 (passwordSecurityId, “|”, “%7C”, , , 真) ＋ “&qrCodeSecurityId=” ＋ 子文本替换 (qrCodeSecurityId, “|”, “%7C”, , , 真) ＋ “&password_input=&password_rsainput=&J_aliedit_using=true&password=&J_aliedit_key_hidn=password&J_aliedit_uid_hidn=alieditUid&alieditUid=” ＋ alieditUid ＋ “&REMOTE_PCID_NAME=_seaside_gogo_pcid&_seaside_gogo_pcid=&_seaside_gogo_=&_seaside_gogo_p=&J_aliedit_prod_type=&security_activeX_enabled=false&J_aliedit_net_info=&checkCode=&idPrefix=&preCheckTimes=” ＋ preCheckTimes ＋ “&ua=”, cookies, , “Host: authgtj.alipay.com” ＋ #换行符 ＋ “Origin: https://auth.alipay.com” ＋ #换行符 ＋ “User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 UBrowser/6.2.4094.1 Safari/537.36” ＋ #换行符 ＋ “” ＋ #换行符 ＋ “Referer: https://auth.alipay.com/login/index.htm?goto=https%3A%2F%2Fconsumeprod.alipay.com%2Frecord%2Fstandard.htm”, , 真, , , )
      	...
      	/*
                ...
                .如果 (寻找文本 (cookies, “userid=”, , 假) ≠ -1)
                    userid ＝ 网页_取单条Cookie (cookies, “billUserId”, 真)
                    通知页面 ＝ 网页访问s (“https://authgtj.alipay.com/login/loginResultDispatch.htm”, 0, , cookies, , “Host: authgtj.alipay.com” ＋ #换行符 ＋ “User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 UBrowser/6.2.4094.1 Safari/537.36” ＋ #换行符 ＋ “” ＋ #换行符 ＋ “Referer: https://auth.alipay.com/login/index.htm?goto=https%3A%2F%2Fconsumeprod.alipay.com%2Frecord%2Fstandard.htm”, , , , , )
                    token ＝ 文本_取出中间文本 (通知页面, #常量15, #常量16, , )
                    uid ＝ 网页_取单条Cookie (cookies, “CLUB_ALIPAY_COM”, 真)
                    ctoken ＝ 网页_取单条Cookie (cookies, “ctoken”, 真)
                    写配置项 (取运行目录 () ＋ “\cookie.txt”, “支付宝”, “cookie”, cookies)
                    调试输出 (“成功”)
                    销毁 ()
