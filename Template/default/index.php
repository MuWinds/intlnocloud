    ...
    <div class="container">
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a href="User/Doc.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['qq']; ?>&site=pay&menu=yes" class="nav-link" target="_blank">
            ...
            <div class="col-lg-6">
              <div class="pr-5">
                ...
                <div class="mt-5">
                  ...
                  <a href="/User/Doc.php" class="btn btn-default my-2">开发文档</a>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="col-md-6">
          <h2 class="display-3 text-white">你凭什么选择我们？</h3>
            <p class="lead text-white">
              提供多种支付接入方式，方便，简单，快捷，快速集成到，效率高，见效快，费率低。支持全球三大主流结算币种，三网免挂软件即时到账,资金无中转。
            </p>
        </div>
      </div>
    </section>
              ...
              <div class="col-lg-4">
                <div class="card card-lift--hover shadow border-0">
                  <div class="card-body py-5">
                    ...
                    <h4 class="h3 text-primary text-uppercase">免挂云支付</h4>
                    <p class="description mt-3">支持支付宝、微信、QQ钱包等主流支付渠道，免挂软件资金实时到账。</p>
                    <div>
        ...
        <div class="row row-grid align-items-center">
          ...
          <div class="col-md-6">
            <div class="pr-md-5">
              ...
              <a onclick="return confirm('请直奔主题,不要问在不在,节省彼此的时间,懂?')" href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['qq']; ?>&site=qq&menu=yes" class="font-weight-bold text-warning mt-5" target="_blank">联系客服</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row row-grid align-items-center">
          ...
          <div class="col-md-6 order-md-1">
            <div class="pr-md-5">
              <h1>快速资金回笼</h1>
              <p>一次轻松接入所有支付（QQ钱包，支付宝，微信），省时省心省力， 费率低，利润高！对接费率超低，比其它平台更便宜.全天监视订单 和资金安全，正规支付接口！</p>
              <a href="/Doc.php" class="font-weight-bold text-info mt-5">了解更多...</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="btn-wrapper">
              <a href="/User/Login.php" class="btn btn-primary">申请商户</a>
              <a href="User/Doc.php" target="_blank" class="btn btn-default mt-3 mt-md-0">开发文档</a>
            </div>
          </div>
        </div>
