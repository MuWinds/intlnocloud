...
<form onsubmit="return searchOrder()" method="GET" class="form-inline">
  <div class="form-group">
    <label>搜索</label>
	<select name="column" class="form-control" default="<?php echo $_GET['column']?$_GET['column']:'trade_no'?>"><option value="trade_no">订单号</option><option value="out_trade_no">商户订单号</option><option value="name">商品名称</option><option value="money">金额</option><option value="ip">支付IP</option><option value="addtime">创建时间</option></select>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
	<select id="dstatus" class="form-control"><option value="0">显示全部</option><option value="1">只显示已完成</option><option value="2">只显示未完成</option></select>
  </div>
